...
//     // Fetch user role and organization ID, then fetch users for the organization
//     useEffect(() => {
//         const fetchUserRoleAndOrganization = async () => {
//             try {
...
//                 setUsers(usersResponse.data.users);
//             } catch (error) {
//                 console.error("Error fetching user role or users:", error);
//             }
//         };
...
//                     </Button>
//                 )}
//                 {/* <Dropdown overlay={userMenu} style={{}}>
//                     <Button>
...
//                 <Dropdown overlay={userMenu}>
//                     <Button>
//                         {selectedUser ? users.find(user => user._id === selectedUser)?.name : 'Select User'} <DownOutlined />
//                     </Button>
//                 </Dropdown>
