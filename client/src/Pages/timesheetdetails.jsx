...
//         const startTime = newData[index].startTime ? moment(newData[index].startTime, 'HH:mm') : null;
//         const endTime = newData[index].endTime ? moment(newData[index].endTime, 'HH:mm') : null;
//         const breakHours = parseFloat(newData[index].breakHours) || 0;

//         if (startTime && endTime) {
//             const totalDuration = moment.duration(endTime.diff(startTime)).asHours();
//             const totalWorked = Math.max(totalDuration - breakHours, 0);
//             newData[index].totalhoursworked = totalWorked.toFixed(2);
//         }
